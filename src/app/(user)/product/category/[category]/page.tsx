...
<div className="flex items-center justify-between bg-white shadow-md rounded-xl p-4 mb-6 border border-gray-100">
      ...
      <div className="text-gray-600 text-lg font-medium">
        Total: <span className="text-amber-600 font-semibold">{products.length}</span>
      </div>
    </div>
      ...
      {products.length > 0 ? (
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="relative w-full rounded-xl overflow-hidden shadow-lg ">
            ...
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-amber-300 via--amber-300 to-transparent text-amber-500 p-6 z-10">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col items-center justify-center py-20">
          <h1 className="text-2xl font-semibold mb-4">এই ক্যাটেগরিতে কোনো ডেটা নেই</h1>
          <Image height={400} width={600} src={noDataImg.src} className="rounded-lg shadow-md" />
        </div>
      )}
      ...
      <div className="col-span-12 lg:col-span-4 space-y-6">
        ...
        {subCategories.length > 0 && (
          <div className="bg-white shadow rounded-xl p-4">
            <h2 className="text-lg font-semibold mb-3 text-amber-500">SUB-CATEGORY</h2>
        ...
        <div className="flex flex-col gap-4">
          {filteredProducts.slice(0, 6).map(product => (
            <SmallCard key={product.id} product={product} className="transition-transform hover:scale-105 hover:shadow-md" />
          ))}
        </div> 
      </div>
    </div>
